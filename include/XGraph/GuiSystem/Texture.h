...
public:		//COSTRUTTORI E CARICAMENTO
	...
	/*Crea una Texture vuota (che �, per�, caricata!) (un rettangolo nero per intenderci)
	Questo metodo di costruzione pu� risultare utile quando si deve
	creare una texture componendola di varie parti di altre textures.
	Una volta creata la texture delle dimensioni richieste � possibile "sovrapporre" pezzi di texture precedentemente caricate
	...
	NOTE:
		Questa funzione pu� essere chiamata solamente dopo aver avviato la finestra grafica dell'applicazione
		altrimenti l'operazione di ottimizzazione bloccher� il processo*/
	...
	NOTE:
		...
		potr� essere liberata a piacimento senza problemi
		
		L'immagine verr� caricata SENZA (in ogni caso) algoritmo di cifratura!*/
...
private:		//FUNZIONI MEMBRO PRIVATE E DATA
	...
	NOTA BENE: La memoria di input pu� essere deallocata senza problemi sicch� la surface verr� caricata in un'area
	di memoria separata!!
