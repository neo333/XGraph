...
public:		//METODI SET/GET
	...
	sar� l'area espressa nel parametro della texture totale caricata.
	...
	/*Imposta l'area dello schermo in cui avverr� il disegno dell'immagine in questione
	...
	/*Ridimensiona un'immagine. L'area di CUT (taglio) verr� resettata!
...
public:		//CARICAMENTO
	...
	*/
	...
	NOTA:
		L'immagine verr� caricata SEMPRE senza algoritmo di cifratura!
	*/
	...
	/*Ritorna true se l'immagine � correttamente caricata*/
...
public:			//FUNZIONI STATICHE AGGIUNTIVE
	...
	/*Ritorna 'true' se il punto del parametro � all'interno dell'area indicata dalla Rect*/
